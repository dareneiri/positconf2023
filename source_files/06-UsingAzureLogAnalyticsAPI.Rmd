---
title: "06 - Using The azlogr Package To Send Logs via API"
output:
  github_document:
    toc: true
    toc_depth: 2
...
2.  [View Microsoft Documentation](https://learn.microsoft.com/en-us/bonsai/cookbook/get-law-id) to find this Workspace ID
3.  Azure Log Analytics Shared Key
4.  [See this Microsoft thread](https://learn.microsoft.com/en-us/answers/questions/1154380/where-is-azure-is-the-primary-key-and-workspace-id) for finding your shared Key.
...
You can start to imagine that if you had multiple APIs, you could separate your logs into its own table. You could also send structured data, which may be valuable if you want to track specific users, accounts, etc.

# Sending additional fields

Let's add a few additional metadata fields in `set_log_config`. We'll pretend we're storing user-specific information that may be useful for future debugging.
...
![](images/azlogr-loganalytics2.png){width="1000"}
